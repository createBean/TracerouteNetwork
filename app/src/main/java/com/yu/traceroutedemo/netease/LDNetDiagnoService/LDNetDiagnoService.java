package com.yu.traceroutedemo.netease.LDNetDiagnoService;

import android.content.Context;
import android.telephony.TelephonyManager;
import android.text.TextUtils;

import com.yu.traceroutedemo.netease.LDNetDiagnoUtils.LDNetUtil;
...
public class LDNetDiagnoService extends
  ...
  public LDNetDiagnoService(Context context, String theAppCode,
                            ...
                            String theDormain, LDNetDiagnoListener theListener) {
      super();
